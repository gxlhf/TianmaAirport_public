      ...
      <div class="container">
        ...
        <div class="col-md-8 pull-right" id="personal-info">
          <ul class="list-inline">
            ...
            <li id="cur-user"> <span class="glyphicon glyphicon-user"></span> 李静 | 已登录</li>
            <li><a class="text-info" href="#">修改个人信息</a></li>
            <li><a class="text-danger" href="#">退出</a></li>
          </ul>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li class="curmenu"><a href="#">用户管理</a></li>
                <li><a href="#">角色管理</a></li>
              </ul>
            </li>
            <li class="dropdown">
      ...
      <div class="row">
        <div class="col-md-2" id="sidebar">
          <ul class="nav nav-pills nav-stacked" role="tablist">
            <li role="presentation" class="first-menu"><strong>用户与角色管理</strong></li>
            <li>
              <ul class="nav nav-pills nav-stacked sub-menu" role="tablist">
                <li role="presentation" class="second-menu-cur"><a href="#">用户管理</a></li>
        ...
        <div class="col-md-10" id="content">
          ...
          <form class="form-horizontal" role="form" class="form-search">
          ...
          <table class="table table-hover select-table">
            <thead>
              <tr>  
                <th><span class="glyphicon glyphicon-check th-check"></span></th>
                <th>员工号</th>
                <th>姓名</th>
                <th>性别</th>
                <th>电话</th>
            ...
            <tbody>
              ...
              <tr class="hidden">
                <td><input type="text" name="selected-option"></td>
              </tr>
            </tbody>
          </table>
          <div>
