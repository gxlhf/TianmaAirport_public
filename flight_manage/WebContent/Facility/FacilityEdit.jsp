          ...
          %>
            ...
            <%
              if(session.getAttribute("priv0")!=null)
                ...
                out.println("<li class='dropdown'><a href='#' class='dropdown-toggle' data-toggle='dropdown' data-hover='dropdown'>乘机指南</a><ul class='dropdown-menu' role='menu'><li><a href='#'>乘机指引</a></li><li class='curmenu'><a href='Public/Facility/Facility.jsp'>物业设施</a></li></ul></li>");
        ...
        <div class="col-md-10" id="content">
          ...
          <form class="form-horizontal" role="form" action = "<%=basePath%>ModifyFacility" method = "post" data-toggle = "validator">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" name="facility-phone" data-error="请填写电话*" value="<%=facilityModify[0].getPhone() %>"  required>
              </div>
              <div class="col-sm-2 help-block with-errors">*</div>
            </div>
