        ...
        <div class="col-md-10" id="content">
          ...
          <form class="form-horizontal" role="form" action = "<%=basePath%>AddFacility" method = "post" data-toggle = "validator">
            <div class="form-group">
              <label for="facility-name" class="col-sm-2 control-label">设施名称：</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" name="facility-name" data-required-error="请填写设施名称*" data-remote="<%=basePath%>AddFacility" data-remote-error="该设施名称已被占用*" data-minlength="4"  required>
              </div>
              <div class="col-sm-2 help-block with-errors">*</div>
            </div>
